...
local fs_create_file = require("nvim-tree.actions.fs.create-file")
...
local function get_containing_folder(node)
  local is_open = fs_create_file.create_in_closed_folder or node.open
...
function fs_create_file.fn(node)
  ...
  vim.ui.input(input_opts, function(new_file_path)
    ...
    if fs_create_file.enable_reload then
