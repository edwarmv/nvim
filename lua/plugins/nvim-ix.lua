return {
  ...
  config = function()
    ...
    do
      -- common.
      ix.charmap.set({ "i", "s" }, "<C-d>", ix.action.scroll(0 + 3))
      ix.charmap.set({ "i", "s" }, "<C-u>", ix.action.scroll(0 - 3))
      ...
      ix.charmap.set({ "i" }, "<C-Space>", ix.action.completion.complete())
      ix.charmap.set({ "i" }, "<C-e>", ix.action.completion.close())
